...
const measureDef_t hm400_measureDef[] = {
  ...
  { IDX_UAC,    CH0, UNIT_V,  CMD82, 14, BYTES2, DIV10  },
  { IDX_IPV,    CH0, UNIT_A,  CMD82, 22, BYTES2, DIV100 },
  { IDX_PAC,    CH0, UNIT_W,  CMD82, 18, BYTES2, DIV10  },
  { IDX_FREQ,   CH0, UNIT_HZ, CMD82, 16, BYTES2, DIV100 },
  { IDX_WR_TEMP,CH0, UNIT_C,  CMD82, 26, BYTES2, DIV10  }
};
