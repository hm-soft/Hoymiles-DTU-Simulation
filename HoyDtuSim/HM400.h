...
const measureDef_t hm400_measureDef[] = {
  ...
  { IDX_UAC,    CH0, UNIT_V,  CMD82, 12, BYTES2, DIV10  },
  { IDX_IPV,    CH0, UNIT_A,  CMD82, 20, BYTES2, DIV100 },
  { IDX_PAC,    CH0, UNIT_W,  CMD82, 16, BYTES2, DIV10  },
  { IDX_FREQ,   CH0, UNIT_HZ, CMD82, 14, BYTES2, DIV100 },
  { IDX_WR_TEMP,CH0, UNIT_C,  CMD82, 24, BYTES2, DIV10  }
};
